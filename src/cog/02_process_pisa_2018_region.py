...
DATA SOURCE CITATION:
    ...
    DOI:        10.5281/zenodo.13383115
    URL:        https://zenodo.org/records/13383115
"""
import pandas as pd
import numpy as np
import os
...
RAW_FILE = PROJECT_ROOT / 'data' / 'raw' / 'Pisa' / 'pisa_2018' / 'CY07_MSU_STU_QQQ.sav'

# Outputs
REPORT_DIR = PROJECT_ROOT / 'reports' / 'varcog'
PATH_CSV = REPORT_DIR / 'data' / 'processed' / 'pisa_2018_regional_summary.csv'
PATH_XLSX = REPORT_DIR / 'xlsx' / 'pisa_2018_regional_summary.xlsx'
